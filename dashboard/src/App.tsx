...
function AppContent() {
  ...
  const handleLogin = (key: string, validatedRole?: string) => {
    ...
    // The login response already carried the role, so no second /auth/validate round-trip is
    // needed here. An absent or unrecognized role falls back to viewer, the least-privileged
    // default.
